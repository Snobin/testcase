...
public class SignupDTO {
	@NotEmpty(message = "{NotEmpty.signup.firstName}")
	@Size(min = 3, max = 100, message = "{Size.signup.firstName.size}")
	...
	@Size(min = 10, max = 10, message = "{validation.signup.phoneNumber.size}")
